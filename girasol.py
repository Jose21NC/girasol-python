...
# Escribe en la parte superior del girasol
turtle.penup()
turtle.goto(0, 220)  # Ajusta la posición vertical según sea necesario
turtle.color("White")  # Color del texto
turtle.write("Para todas esas personitas q\nno tienen su flor amarilla <3", align="center", font=("Arial", 24, "bold"))
